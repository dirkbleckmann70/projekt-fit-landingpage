...
export default async function handler(req, res) {
  ...
  try {
    if (req.method === 'POST') {
      const { name, trainer_id, city, location, weekday, time, max_participants, price_per_person_cents, description } = req.body;
    ...
    if (req.method === 'PUT') {
      ...
      const allowed = [
        'name', 'trainer_id', 'city', 'location', 'weekday', 'time',
        'max_participants', 'price_per_person_cents', 'description', 'is_active',
      ];
